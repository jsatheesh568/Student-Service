...
@io.swagger.annotations.Api(tags = "Employee Management")
public class EmployeeController {
    ...
    @io.swagger.annotations.ApiOperation("Get all employees")
    ...
    @io.swagger.annotations.ApiOperation("Get employee by ID")
    ...
    @io.swagger.annotations.ApiOperation("Get employee by name")
    ...
    @io.swagger.annotations.ApiOperation("Get employees by city")
    ...
    @io.swagger.annotations.ApiOperation("Create a new employee")
    ...
    @io.swagger.annotations.ApiOperation("Update employee by ID")
    ...
    @io.swagger.annotations.ApiOperation("Delete employee by ID")
